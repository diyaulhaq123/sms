    ...
    formCheckInputPayment.forEach(function (paymentInput) {
      paymentInput.addEventListener('change', function (e) {
        ...
        if (paymentInputValue === 'credit-card') {
          document.querySelector('#individual-register').classList.add('d-none');
          document.querySelector('#business-register').classList.remove('d-none');
        } else {
          document.querySelector('#individual-register').classList.remove('d-none');
          document.querySelector('#business-register').classList.add('d-none');
        }
      });
    });
  }
