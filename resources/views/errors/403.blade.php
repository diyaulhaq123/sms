            ...
            <div class="col-12 justify-content-center" style="margin-left: auto; margin-right: auto">
                <center>
                    <div class="misc-wrapper">
                        <h2 class="mb-1 mt-4">Permission Denied :</h2>
                        <p class="mb-4 mx-2">You do not have access to this resource.</p>
                        ...
                        <div class="mt-4" style="max-width: 800px">
                            <img src="{{asset('dashboard/img/illustrations/page-misc-you-are-not-authorized.png') }}" alt="page-misc-error" width="50%" class="img-fluid">
                        </div>
                    </div>
                </center>
            </div>
