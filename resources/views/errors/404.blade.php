        ...
        <div class="row ">
            <div class="col-12 justify-content-center" style="margin-left: auto; margin-right: auto">
                ...
                <div class="misc-wrapper">
                    <h2 class="mb-1 mt-4">Page Not Found or is not available :</h2>
                    <p class="mb-4 mx-2">Oops! 😖 The requested URL was not found on this server.</p>
                    <a href="{{ route('dashboard') }}" class="btn btn-primary mb-4 waves-effect waves-light">Back to home</a>
                    <div class="mt-4">
                    <img src="{{asset('dashboard/img/illustrations/page-misc-error.png') }}" alt="page-misc-error" width="225" class="img-fluid">
                    </div>
                </div>
                </center>
            </div>
