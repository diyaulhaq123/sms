            ...
            <div class="col-12 justify-content-center" style="margin-left: auto; margin-right: auto">
                <center>
                    <div class="misc-wrapper">
                        <h2 class="mb-1 mt-4">Invalide Call to page :</h2>
                        <p class="mb-4 mx-2">Session has either expired or this page was accessed wrongly.</p>
                        ...
                        <div class="mt-4" style="max-width: 800px">
                            <img src="{{asset('dashboard/img/error-500.jpg') }}" alt="page-misc-error" width="50%" class="img-fluid">
                        </div>
                    </div>
                </center>
            </div>
