...
@slot('title') Payment Activations  @endslot
@endcomponent
...
<div class="row">
    ...
    <div class="card p-4">
        <div class="card-header">
            <form action="{{ route('payment_activation.store') }}" method="post">
                @csrf
                <div class="row">
        ...
        <div class="card-body">
            <div class="card-title fw-bold">Payment Activations</div>
            ...
            <div class="col-10">
                <div class="table table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($activations as $index => $row)
                            <tr>
                                ...
                                <td >
                                    <div class="btn-group">
                                        ...
                                        <a class="btn btn-info btn-sm" href="{{ route('payment_activation.edit', $row->id) }}" ><i class="ri ri-edit-fill"></i></a>
                                        </div>
                                        <form action="{{ route('payment_activation.destroy', $row->id) }}" method="post">
                                            @csrf
                                            @method('delete')
    ...
    <script>
        ...
        $(document).ready(function(){
            $('.form-check-input').change(function () {
                ...
                const url = `/toogle-activate-payment/${id}`;
                $.ajax({
                    url: url,
                    method: 'PUT',
                    data: {
