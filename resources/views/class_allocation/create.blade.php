...
@slot('title') Add Class Allocations  @endslot
@endcomponent
...
<div class="row">
    ...
    <div class="card p-4">
        ...
        <div class="card-body">
            <div class="card-title fw-bold">Create Class Allocations</div>
           <div class="row justify-content-center">
            <div class="col-8 mt-2">
                <form action="{{ route('class-allocations.store') }}" method="post">
                    @csrf
