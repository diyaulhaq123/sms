...
@slot('title') Payment Types  @endslot
@endcomponent
...
<div class="row">
    ...
    <div class="card p-4">
        <div class="card-header">
            <a class="btn btn-primary float-end" href="{{ route('payment_type.create') }}" > <i class="ri-add-circle-line"></i> Add Payment Type</a>
        </div>
        <div class="card-body">
            <div class="card-title fw-bold">Payment Types</div>
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th style="font-size:15px">
                                        <a class="text-dark" href="{{ route('payment_type.edit', $row->id) }}" >
                                            {{ $row->name }}
                                        </a> 
                                </th>
                                <th class="float-end">
    ...
    <script>
        ...
        $(document).ready(function(){
            $('.form-check-input').change(function () {
                ...
                const url = `/toogle-payment_types/${id}`;
                $.ajax({
                    url: url,
                    method: 'PUT',
                    data: {
