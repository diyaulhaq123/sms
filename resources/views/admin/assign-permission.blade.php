...
<div class="row justify-content-between">
    <div class="col">Assign Roles And Permissions</div>
    <div class="col-4">
        <a href="{{ route('revoke.index') }}" class="btn btn-primary">Revoke Permissions</a>
    </div>
</div>
@endsection
...
<form action="{{route('assign.role')}}" method="post" class="mb-3">
    @csrf
