          ...
          <div class="card-body">
            <div class="user-avatar-section">
              <div class="d-flex align-items-center flex-column">
                <img class="img-fluid rounded mb-3 pt-1 mt-4" src="{{ asset( auth()->user()->profile ? auth()->user()->profile->avatar : 'dashboard/img/dummy.jpeg') }}" height="100" width="100" alt="User avatar">
                <div class="user-info text-center">
                  ...
                  <span class="badge bg-label-info mt-1 text-uppercase">{{ auth()->user()->type }}</span>
                </div>
              </div>
            </div>
            {{-- <div class="d-flex justify-content-around flex-wrap mt-3 pt-3 pb-4 border-bottom">
              <div class=" align-items-start me-4 mt-3 gap-2">
                <span class="badge bg-label-primary p-2 rounded"><i class="ti ti-checkbox ti-sm"></i></span>
                <div>
                  <p class="mb-0 fw-medium">211</p>
            ...
            <p class="mt-4 small text-uppercase text-muted">User Information</p>
            <div class="info-container">
              <ul class="list-unstyled">
                ...
                <li class="mb-2 pt-1">
                  ...
                  <span>{{ $staff ? $staff->phone_number : '-' }}</span>
                </li>
                <li class="mb-2 pt-1">
                  <span class="fw-medium me-1">Nationality:</span>
                  <span>{{ $staff ? $staff->nationality : '-' }}</span>
                </li>
                {{-- <li class="pt-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-12 my-2">
                            ...
                            <select class="form-control form-select" name="gender" id="gender">
                                ...
                                <option value="Male" @if ($staff && $staff->gender == 'Male') {!! 'selected' !!}  @endif >Male</option>
                                <option value="Female" @if ($staff && $staff->gender == 'Female') {!! 'selected' !!}  @endif>Female</option>
                            </select>
                            @error('gender')
                            <span class="text-danger" style="font-size:12px">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-lg-4 col-sm-12 my-2">
                            ...
                            <select class="form-control form-select" name="marital_status" id="marital_status">
                                ...
                                <option value="Single" @if($staff && $staff->marital_status == 'Single') {!! 'selected' !!}  @endif >Single</option>
                                <option value="Married" @if($staff && $staff->marital_status == 'Married') {!! 'selected' !!}  @endif >Married</option>
                                <option value="Divorced" @if($staff && $staff->marital_status == 'Divorced') {!! 'selected' !!}  @endif >Divorced</option>
                                <option value="Disclosed" @if($staff && $staff->marital_status == 'Disclosed') {!! 'selected' !!}  @endif >Disclosed</option>
                            </select>
                        ...
                        <div class="col-lg-4 col-sm-12 my-2">
                            ...
                            <select class="form-control form-select" name="nationality" id="nationality">
                                ...
                                <option value="NG" @if($staff && $staff->nationality == 'NG') {!! 'selected' !!}  @endif>Nigerian</option>
                            </select>
                            @error('nationality')
                            <span class="text-danger" style="font-size:12px">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-lg-4 col-sm-12 my-2">
                            ...
                            <select class="form-control form-select" name="state" id="state_id">
                                ...
                                <option value="{{ $row->id }}" @if($staff && $staff->state == $row->id ) {!! 'selected' !!}  @endif >{{ $row->name }}</option>
                                @endforeach
                            </select>
                            @error('state')
                            <span class="text-danger" style="font-size:12px">{{ $message }}</span>
                        ...
                        <div class="col-lg-4 col-sm-12 my-2">
                            ...
                            <select class="form-control form-select" name="lga" id="lga_id">
                                ...
                                @foreach ($lgas as $row)
                                <option value="{{ $row->id }}" @if($staff && $staff->lga == $row->id ) {!! 'selected' !!}  @endif >{{ $row->name }}</option>
                                @endforeach
                            </select>
                            @error('lga')
                            <span class="text-danger" style="font-size:12px">{{ $message }}</span>
                        ...
                        <div class="col-lg-4 col-sm-12 my-2">
                            ...
                            value="{{ $staff ? $staff->date_of_birth : '' }}" >
                            @error('date_of_birth')
                            <span class="text-danger" style="font-size:12px">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-lg-4 col-sm-12 my-2">
                            ...
                            value="{{ $staff ? $staff->place_of_birth : '' }}" >
                        ...
                        <div class="col-lg-6 col-sm-12 my-2">
                            ...
                            value="{{ $staff ? $staff->address_line_1 : '' }}" >
                        ...
                        <div class="col-lg-6 col-sm-12 my-2">
                            ...
                            value="{{ $staff ? $staff->address_line_2 : '' }}" >
