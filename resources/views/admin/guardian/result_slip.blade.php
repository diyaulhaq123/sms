...
<div class="container p-5">
    <div class="row justify-content-center mt-3">
        @if ($validate_child)
            ...
            @if($result_status)
                ...
                <div class="col-lg-10" id="fullscreenDiv">
                    <div class="d-flex justify-content-between" >
                        <div class="btn-group mb-2">
                            <a href="{{  route('gurdian.result.index', $student->id) }}" class="btn btn-danger btn-sm">Back</a>
                    ...
                    <div class="card p-3">
                        <div class="card-header">
                            ...
                            <div class="row justify-content-between" >
                                ...
                                <div class="col-4" >
                                    <p>Total Points: {{ $statistics->total_score ?? 'NA' }}</p>
                                    <p class="">Average: </p>
                                    <p>Position: </p>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-2 mb-2">
                        <a href="{{ route('gurdian.result.index', $payment->student_id) }}" class="btn btn-primary">Go Back</a>
                    </div>
                </div>
                <div class="alert alert-danger text-center">Please pay your outstanding balance of <del>N</del> {{number_format($payment->balance, 2)}}
                    <a href="javascript:void(0)" class="btn btn-info">Pay Online</a>
                    Or Visit the school bursary department to complete payment
                </div>

                @else
                <div class="row">
                    <div class="col-2 mb-2">
                        <a href="{{ route('gurdian.result.index', request()->get('student_id') ) }}" class="btn btn-primary">Go Back</a>
                    </div>
                </div>
                <div class="alert alert-danger text-center">Payment not found, tuition fee has not been paid for requested session & term
                    <a href="javascript:void(0)" class="btn btn-info">Pay Online Now</a> Or Visit the school bursary department to complete payment
                </div>
                @endif
            @else
            <div class="row">
            ...
            <div class="alert alert-danger text-center">Result for current request is not ready</div>
